...
const LocationCard = ({ name, schedule }: LocationCardProps) => {
  return (
    <div className="group rounded-2xl bg-card p-8 shadow-soft transition-all duration-300 hover:shadow-hover">
  ...
  const locations = [
    {
      name: "Glyfada",
      schedule: [
        { days: "Monday – Friday", hours: "17:30–00:00" },
        { days: "Friday – Saturday", hours: "12:30–01:30" },
        { days: "Sunday", hours: "12:30–01:00" },
      ],
    },
    {
      name: "Avana",
      schedule: [
        { days: "Monday – Thursday", hours: "12:00–00:30" },
        { days: "Friday – Saturday", hours: "12:00–01:30" },
      ],
    },
  ];

  return (
    <section id="locations" className="bg-muted py-20 md:py-28">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-4 font-body text-lg text-muted-foreground">
              Two locations in Greece serving up the best smash burgers you'll ever taste.
            </p>
          ...
          <div className="relative">
            <div className="aspect-[4/5] overflow-hidden rounded-3xl shadow-card">
              <img
                src={fillerImage}
                alt="Epos Burgers served with style"
