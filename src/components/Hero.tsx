  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={bannerImage}
          alt="Delicious Epos Burgers with fries and dipping sauces"
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 pt-20">
        <div className="animate-fade-up text-center" style={{ animationDelay: '0.2s' }}>
          <img
            src={logo}
            alt="Epos Burgers Logo - est. 2024"
            className="mx-auto mb-8 h-40 w-40 rounded-full object-cover shadow-card md:h-56 md:w-56"
          />
          <h1 className="font-display text-4xl font-bold tracking-tight text-secondary md:text-6xl lg:text-7xl">
            Smash Burgers
          </h1>
